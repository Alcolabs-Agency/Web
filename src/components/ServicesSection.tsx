    ...
    <section className="flex justify-center items-center px-4 py-16 bg-gradient-to-r from-[#5232A1] via-[#4007b9] to-black text-white min-h-screen">
      <div className="relative z-10 container mx-auto px-20"> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 -mt-16">
          ...
          <div className="lg:col-span-2 p-12 rounded-lg shadow-lg bg-white text-black">
            <h2 className="text-2xl font-bold text-[#5232A1] mb-4">Services</h2>
          ...
          <div className="p-6 rounded-lg shadow-lg bg-[#501bd6] text-white">
            <div className="flex items-center mb-3">
              ...
              <h3 className="text-1xl font-bold">Web 3 Consulting and Adaptation</h3>
            </div>
          ...
          <div className="p-5 rounded-lg shadow-lg bg-white text-black">
            ...
            <FaUsers className="text-6xl text-[#5232A1] mr-1" />
              <h3 className="text-1xl font-bold">Maintenance and Technical Support</h3>
    
            </div>
            <p className="font-sans text-sm">We offer ongoing maintenance to keep your website up-to-date, secure and running as agreed in your contract.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
          ...
          <div className="p-6 rounded-lg shadow-lg bg-white text-black">
            ...
            <p className="font-sans text-sm">We optimize your site&apos;s SEO to improve its positioning, speed, and accessibility, making it more competitive in the digital enviroment.</p>
          </div>
          ...
          <div className="p-6 rounded-lg shadow-lg bg-white text-black">
            ...
            <p className="font-sans text-sm">We develop custom websites with customized front-end and back-end solutions for optimal performance and attractive design.</p>
          </div>
          ...
          <div className="p-5 rounded-lg shadow-lg bg-white text-black">
            ...
            <HiOutlineDesktopComputer className="text-7xl text-[#5232A1] mr-3" />
              <h3 className="text-xl font-bold">WordPress Web Development</h3>
            </div>
