...
const WhyChooseUs = () => {
    return (
        <section className="flex justify-center items-center px-16 py-16 bg-gradient-to-r from-[#5232A1] via-[#4007b9] to-black text-white min-h-screen">
            <div className="flex flex-row-reverse gap-16 w-full max-w-7xl">
                ...
                <div className="flex-1 max-w-[50%] flex flex-col justify-center px-8">
                    <h1 className="text-5xl font-extrabold --font-sf-pro">Why Choose Us</h1> <br/>
                    ...
                    <h3 className="font-extrabold mt-4">1. Tailor-made solutions:</h3>
                    ...
                    <h3 className="font-extrabold mt-4">4. Dedicated support:</h3>
                    <p className="--font-sf-pro">
