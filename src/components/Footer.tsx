    ...
    >
      <div className=" max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div>
            <h3 className="text-lg font-bold text-white mb-4 font-SFmedium">Follow Us</h3>
      ...
      <div className="flex justify-around pt-20 mt-8 border-white  text-white text-center">
        <p className="text-white ">Copyright © 2024</p>
        <span>
        <a href="#" className="hover:text-gray-100 mx-5">Terms & Conditions</a>
