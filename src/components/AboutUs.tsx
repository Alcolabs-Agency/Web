...
const AboutUs = () => {
  return (
    <section
      id="aboutus"
      className="flex justify-between items-center px-32 py-20 bg-gradient-to-r from-[#5232A1] via-[#4007b9] to-black text-white min-h-screen"
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center relative z-10">
        <div className="relative w-[477px] h-[596px] mr-auto">
          <Image 
            ...
            width={477}
            height={596}
            className="w-full h-full object-cover rounded-md md:rounded-none -mt-12"
          />
        </div>

        <div className="md:mt-3 md:w-1/2 text-center text-white px-6">
          <h2 className="text-5xl font-bold -mt-16">About Us</h2>
          <p className="text-lg mb-28 py-8">
