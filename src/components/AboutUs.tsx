...
const AboutUs = () => {
  return (
<section className="bg-gradient-to-r from-purple-900 via-purple-800 to-black pt-20 pb-72 mx-auto">
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
    <div className="relative w-full md:w-[477px] h-[596px] mr-auto">
      <Image 
    ...
    <div className="mt-8 md:mt-0 md:w-1/2 text-white px-4">
      <h2 className="text-6xl font-bold mb-28 text-center">About Us</h2>
      <p className="text-lg text-justify md:text-left md:text-center mx-4 md:mx-0"> 
